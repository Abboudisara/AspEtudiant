...
using GestEtudiant.Data;
using GestEtudiant.Models;

namespace GestEtudiant.Controllers
{
    public class JokesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,jokQuestion,JokAnswer")] Jokes jokes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,jokQuestion,JokAnswer")] Jokes jokes)
        {
            if (id != jokes.Id)
            {
                return NotFound();
